...
def get_bboxes_grid(fig: Figure, axes_grid: utils.Array[Axes]) -> utils.Array[Bbox]: ...
...
def get_caxes_grid(axes_grid: utils.Array[Axes]) -> utils.Array[Axes]: ...


def get_caxes_bboxes_grid(
    fig: Figure, caxes_grid: utils.Array[Axes]
) -> utils.Array[Bbox]: ...


def get_hspaces(
    use_bbox: tuple[bool, ...], bboxes: utils.Array[Bbox], tbboxes: utils.Array[Bbox]
) -> NDArray[np.float64]: ...
...
def add_hspace(fig, idx, space, axes_grid, axes_bboxes, caxes_grid, caxes_bboxes): ...
def add_vspace(fig, idx, space, axes_grid, axes_bboxes, caxes_grid, caxes_bboxes): ...
